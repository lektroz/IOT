...
class IotViewIo_list extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root()."components/com_iot/assets/css/io_list.css", (IotHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root(). "components/com_iot/views/io_list/submitbutton.js", (IotHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
//add custom
