...
class IotViewBoards extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$HeaderCheck = new iotHeaderCheck;
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_iot/assets/css/boards.css', (IotHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	public function escape($var, $sorten = false, $length = 40)
	{
		...
		return IotHelper::htmlEscape($var, $this->_charset, $sorten, $length);
	}
}
