...
/**
 * Io_lists Table class
 */
class IotTableIo_list extends JTable
{
	/**
	...
	{
		parent::__construct('#__iot_io_list', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_iot.io_list'));
	}	
	...
	/**
	 * Overload the store method for the Io_list table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New io_list. A io_list created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_IOT_IO_LIST_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_iot.io_list.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_iot.io_list.'.(int) $this->$k;
	}
