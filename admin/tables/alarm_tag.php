...
/**
 * Alarm_tags Table class
 */
class IotTableAlarm_tag extends JTable
{
	/**
	...
	{
		parent::__construct('#__iot_alarm_tag', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_iot.alarm_tag'));
	}	
	...
	/**
	 * Overload the store method for the Alarm_tag table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New alarm_tag. A alarm_tag created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_IOT_ALARM_TAG_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_iot.alarm_tag.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_iot.alarm_tag.'.(int) $this->$k;
	}
