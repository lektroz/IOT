...
/**
 * Event_tags Table class
 */
class IotTableEvent_tag extends JTable
{
	/**
	...
	{
		parent::__construct('#__iot_event_tag', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_iot.event_tag'));
	}	
	...
	/**
	 * Overload the store method for the Event_tag table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New event_tag. A event_tag created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_IOT_EVENT_TAG_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_iot.event_tag.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_iot.event_tag.'.(int) $this->$k;
	}
