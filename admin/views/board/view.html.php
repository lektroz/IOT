...
class IotViewBoard extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_iot/assets/css/board.css", (IotHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		// Add Ajax Token
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_iot/views/board/submitbutton.js", (IotHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
