 ...
 * Iot View class
 */
class IotViewIot extends JViewLegacy
{
	/**
	 * View display method
	 * @return void
	...
	function display($tpl = null)
	{
		...
		$this->contributors		= IotHelper::getContributors();
		
		// get the manifest details of the component
		$this->manifest = IotHelper::manifest();
	...
	{
		$canDo = IotHelper::getActions('iot');
		JToolBarHelper::title(JText::_('COM_IOT_DASHBOARD'), 'grid-2');

		// set help url for this view if found
		$help_url = IotHelper::getHelpUrl('iot');
	...
	protected function setDocument()
	{
		...
		$document->addStyleSheet(JURI::root() . "administrator/components/com_iot/assets/css/dashboard.css");
		
		// set page title
		$document->setTitle(JText::_('COM_IOT_DASHBOARD'));
