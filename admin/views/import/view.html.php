 ...
 * Iot Import View
 */
class IotViewImport extends JViewLegacy
{
	...
	{		
		...
		$this->canDo = IotHelper::getActions('import');
		...
		if($this->hasPackage && $this->dataType)
		{
			...
			$this->headers 		= IotHelper::getFileHeaders($this->dataType);
			// clear the data type
	...
	{
		JToolBarHelper::title(JText::_('COM_IOT_IMPORT_TITLE'), 'upload');
		JHtmlSidebar::setAction('index.php?option=com_iot&view=import');
		...
		$help_url = IotHelper::getHelpUrl('import');
